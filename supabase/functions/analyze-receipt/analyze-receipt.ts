// analyze-receipt.ts — Supabase Edge Function (Deno runtime)
// Bu dosya Expo/Node değil, Deno ile çalışır.
// VS Code'da Deno extension kurulu değilse tip hataları görünebilir — bu normaldir.
// Gerçek çalışma Supabase üzerinde sorunsuz olur.
